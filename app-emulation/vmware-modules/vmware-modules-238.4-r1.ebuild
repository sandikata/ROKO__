...
DESCRIPTION="VMware kernel modules. Тази версия е кърпена специално за ядрата от серия linux-3.0 (възможно е да работи и с ядрото linux-2.6.39, но не е гарантирано!)"
