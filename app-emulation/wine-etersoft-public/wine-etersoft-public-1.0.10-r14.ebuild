...
SRC_URI="ftp://updates.etersoft.ru/pub/Etersoft/WINE@Etersoft/${PV}/sources/wine-etersoft-${PV}-alt${PR#r}.src.rpm"
...
RDEPEND=">=media-libs/freetype-2.0.0
	!app-emulation/wine
	cifs? ( >=app-emulation/etercifs-4.2.1 )
...
src_unpack() {
	...
	cd ${WORKDIR}
	tar -xjf "wine-etersoft-${PV}.tar.bz2"
	cd "${WORKDIR}"/wine-etersoft-${PV}/
