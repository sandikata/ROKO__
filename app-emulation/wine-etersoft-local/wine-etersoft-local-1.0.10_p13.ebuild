...
SRC_URI="${P%_p*}-eter${PV#*_p}gentoo.tbz2"
...
RDEPEND=">=media-libs/freetype-2.0.0
	...
	>=app-emulation/wine-etersoft-public-${PV%_p*}_p19
...
pkg_nofetch() {
	einfo "Please download the appropriate WINE@Etersoft-Local archive ${P%_p*}-eter${PV#*_p}gentoo.tbz2"
...
src_install() {
	...
	use amd64 && { dodir /usr/lib32 ; cp -R "${WORKDIR}"/usr/lib/* "${D}"/usr/lib32/ || die "cp libs"; }
