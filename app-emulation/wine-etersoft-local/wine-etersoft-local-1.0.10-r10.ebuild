...
SRC_URI="${MY_P}-alt10.M41.11.i586.rpm"
...
RDEPEND=">=media-libs/freetype-2.0.0
	...
	>=app-emulation/wine-etersoft-public-${PV}-r16
...
pkg_nofetch() {
	einfo "Please download the appropriate WINE@Etersoft-Local archive	(${MY_P}-alt10.M41.11.i586.rpm)"
