...
SRC_URI="x86? ( http://www.fmod.org/download/fmodex/api/Linux/fmodapi42636linux.tar.gz )
		amd64? ( http://www.fmod.org/download/fmodex/api/Linux/fmodapi42636linux64.tar.gz )"
