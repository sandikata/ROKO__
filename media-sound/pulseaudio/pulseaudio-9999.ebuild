...
inherit autotools bash-completion-r1 eutils flag-o-matic git-r3 linux-info readme.gentoo systemd user versionator udev multilib-minimal
...
system-wide tcpd tdb test +udev +webrtc-aec +X xen zeroconf"
