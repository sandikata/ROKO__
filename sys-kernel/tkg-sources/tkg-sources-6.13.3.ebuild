...
GIT_COMMIT_CACHYOS="b12399240fa83142e9dcfbb5409e27e1cc5e8e76"
...
SRC_URI="
	...
	amd-tlb-brd? ( ${CACHYOS_URI}/0002-amd-tlb-broadcast.patch -> ${P}-0002-amd-tlb-broadcast.patch )
...
src_prepare() {
	...
	use amd-tlb-brd && eapply "${DISTDIR}/${P}-0002-amd-tlb-broadcast.patch"
