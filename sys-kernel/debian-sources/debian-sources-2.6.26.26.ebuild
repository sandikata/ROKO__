...
KEYWORDS="amd64 x86"
DESCRIPTION="Debian Lenny Sources - with optional OpenVZ support"
HOMEPAGE="http://www.debian.org"
SRC_URI="
	 http://ftp.bg.debian.org/debian/pool/main/l/linux-2.6/linux-2.6_2.6.26.orig.tar.gz
	 http://ftp.bg.debian.org/debian/pool/main/l/linux-2.6/linux-2.6_2.6.26-26lenny2.diff.gz"
UNIPATCH_STRICTORDER=1
IUSE="openvz"
K_EXTRAEINFO=""
DEPEND="<=sys-fs/udev-124-r2"
RDEPEND="<=sys-fs/udev-124-r2"

src_unpack() {
	cd ${WORKDIR}
	unpack linux-2.6_2.6.26.orig.tar.gz
	cat ${DISTDIR}/linux-2.6_2.6.26-26lenny2.diff.gz | gzip -d | patch -p1 || die
