...
DESCRIPTION="Floorp Browser - A fast, privacy-focused Firefox fork"
HOMEPAGE="https://floorp.app/"
SRC_URI="https://github.com/Floorp-Projects/Floorp/releases/download/v${PV}/floorp-linux-x86_64.tar.xz -> ${P}.tar.xz"
...
src_install() {
	#create dest dir
	local destdir="/opt/floorp"
	insinto "${destdir}"
	doins -r *
	#create a symlink to the binary
	dosym "${destdir}/floorp-bin" "/usr/bin/floorp" || die
	#add icons
	local size
