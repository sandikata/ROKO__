...
inherit mount-boot eutils toolchain-funcs poly-c_ebuilds

DESCRIPTION="Memory tester based on memtest86"
HOMEPAGE="http://www.memtest.org/"
SRC_URI="http://www.memtest.org/download/${MY_PV}/${MY_P}.tar.gz"
...
src_prepare() {
	sed -e "/scp memtest.bin root@192.168.0.12:\/srv\/tftp\/mt86plus/d" \
		-i Makefile || die
